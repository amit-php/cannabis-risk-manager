                    ...
                    <div class="featured-main-box">
                        <div class="featured-img-box">
                            ...
                            <div class="category-details-box">
                                ...
                                <h4><a href="#">New Study Finds CBD Lotion Reduces Skin Damage from UV Rays</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="featured-right-img-box">
                        <div class="featured-right-img">
                            <img src="<?php echo THEME_DIR; ?>/images/featured-main-img.jpg" alt="featured-main-img">
                        </div>
                        <div class="category-details-box">
                            <ul class="category-tag">
                                <li>News</li>
                            ...
                            <h3><a href="#">Cannabis Firm Faces Insurance Dispute After Grow Room Blaze</a></h3>
                            <div class="date-wrapper-main">
                                <div class="detail-box">
                                    <span><img src="<?php echo THEME_DIR; ?>/images/profile.svg" alt="profile"></span>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="featured-right-img-box risk-manage-ment-wrapper">
                        <div class="featured-right-img">
                            <img src="<?php echo THEME_DIR; ?>/images/risk-manage-ment-bg-4.jpg" alt="risk-manageMent">
                        </div>
                        <div class="category-details-box">
                            <ul class="category-tag">
                                <li>News</li>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="letest-news-box">
                        <div class="letest-news-img">
                            <img src="<?php echo THEME_DIR; ?>/images/risk-manage-ment-bg.jpg" alt="risk-manageMent">
                        </div>
                        <div class="category-details-box">
                            <ul class="category-tag">
                                <li>News</li>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="letest-news-box">
                        <div class="letest-news-img">
                            <img src="<?php echo THEME_DIR; ?>/images/risk-manage-ment-bg-2.jpg" alt="risk-manageMent">
                        </div>
                        <div class="category-details-box">
                            <ul class="category-tag">
                                <li>News</li>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="letest-news-box">
                        <div class="letest-news-img">
                            <img src="<?php echo THEME_DIR; ?>/images/risk-manage-ment-bg-3.jpg" alt="risk-manageMent">
                        </div>
                        <div class="category-details-box">
                            <ul class="category-tag">
                                <li>News</li>
