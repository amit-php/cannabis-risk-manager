...
// }
 ...
 ?>
    <section class="banner-sec inner-banner">
        <img class="banner-img" src="<?php echo get_theme_value('nws_banner_image') ; ?>" alt="">
    ...
    <?php 
     $getPopularpost = get_popular_posts(4,"news","news_type");
    //  echo "<pre/>";
...
if ($getPopularpost) :
                ...
                <div class="col-lg-12">
                    <div class="common-heading">
                        <div class="common-heading-text">
                            <h2><?php echo get_theme_value('popular_news') ; ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="letest-news all-business-news-sec common-padd pt-0">
        <div class="container">
            <div class="common-heading">
                <div class="common-heading-text">
                    <h2><?php echo get_theme_value('all_news') ; ?></h2>
                </div>
            </div>

            <div class="row">
                <?php 
                $getAllpost = get_posts_with_tax_and_pagination('news','news_type', false , 6);
